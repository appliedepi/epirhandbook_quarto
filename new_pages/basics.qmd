...
Another example about basic functions is the `mean()` function. This function calculates the average of a numeric vector. In the example below, the `mean()` function is applied to the numeric column `age` in the dataset `linelist`, and the output is the average age of the cases in the dataset.
