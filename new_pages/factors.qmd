...
It is important to mention that the book repository is, in part an R package, and the command `devtools::install_github("cienciadedatos/r4ds")` shall install the book’s dependencies by __reading the DESCRIPTION file on it__.
