...
* <a href='https://github.com/appliedepi/epirhandbook_eng/raw/master/data/case_linelists/linelist_raw.xlsx' class='download-button'>Кликните, чтобы скачать the "сырой" построчный список (.xlsx)</span></a>. "Сырой" построчный список случаев - таблица Excel с хаотичными данными. Используйте ее, чтобы выполнять шаги на странице [Вычистка данных и ключевые функции].  
...
Страница [Отслеживание контактов] демонстрирует анализ данных по отслеживанию контактов, используя пример данных из [Go.Data](https://github.com/WorldHealthOrganization/godata/tree/master/analytics/r-reporting). Данные, используемые на этой странице, могут быть скачены как файлы .rds, кликнув на следующие ссылки:  
