...
**Sử dụng**: Sổ tay này đã được sử dụng trên **5 triệu lần bởi 450,000 người** trên toàn thế giới.

Thêm một dòng test ở đây
...
**Cuốn sách này khác các cuốn sách về R khác như thế nào?**   

 * Nó hướng đến cộng đồng - *được các nhà dịch tễ học viết cho các nhà dịch tễ học* trong thời gian rảnh rỗi của họ và tận dụng kinh nghiệm ở các cơ sở địa phương, quốc gia, học thuật và trường hợp khẩn cấp 
...
Applied Epi là một tổ chức phi lợi nhuận của các nhà dịch tễ học thực địa từ khắp mọi nơi trên thế giới. Chúng tôi dành thời gian rảnh rỗi của mình để viết và cung cấp tài liệu này cho cộng đồng. Mọi lời động viên khuyến khích và phản hồi của bạn đều được chúng tôi chào đón thông qua các phương thức liên lạc sau:
