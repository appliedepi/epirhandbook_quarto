...
**Mục tiêu:** Là một tài liệu tham khảo R một cách nhanh chóng (trực tuyến và **[ngoại tuyến](#data-used)**), cung cấp các ví dụ tập trung vào nhiệm vụ giải quyết các vấn đề dịch tễ học phổ biến.  
...
-   Kết hợp theo dõi cùng với các bộ [dữ liệu minh họa](#data-used)\
-   Xem phần "Tài nguyên" trong từng chương để tìm thêm tài liệu

**Phiên bản ngoại tuyến**

Xem hướng dẫn tại trang [Tải sách và dữ liệu](#data-used).
